...
double SuffixMatcher::score(const std::string& haystack) const {
  /*
  @brief Checks if the needle is a suffix of the haystack.
  @return A score of 1.0 if the needle is found as a suffix in the haystack,
  otherwise 0.0.
  */
  if (haystack.size() < _needle.size()) return 0.0;
